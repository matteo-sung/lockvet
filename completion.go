...
.PP
It understands 43 formats (incl. GitHub Actions workflows, Dockerfiles/Compose, Kubernetes manifests & kustomizations, pre-commit configs and Gradle version catalogs / verification metadata) across the npm, pnpm, yarn, bun, Cargo,
